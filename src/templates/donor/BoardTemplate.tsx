...
export default function BoardTemplate(props: { user: TActiveUserSession }) {
  const [isVerificationWarning, setIsVerificationWarning] = useState(false);

  const productsData = useSWR(
    "ProductsService.ListDonorProducts",
            ...
            <div>
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-stone-500 mb-6 max-w-sm mx-auto mt-2">
                  Sorry {props.user?.donor?.firstName}, but you need to complete
                  your KYC Verification to pay for an item.
                </p>

                <Link
                  href={Routes.Donor.Board}
